                        ...
                        <div class="card-body">
                            <form name="my-form"  action="val" method="post">
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                             		<input type="checkbox" value="Java" name="course" id="course">Java
                             		<input type="checkbox" value="Php" name="course" id="course">Php
                             		<input type="checkbox" value="Pythen" name="course" id="course">Pythen
                             		<input type="checkbox" value="C++" name="course" id="course">C++
									</div>
								  </div>
