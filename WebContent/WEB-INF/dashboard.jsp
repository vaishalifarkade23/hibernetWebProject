...
<label class="text-SlateBlue font-weight-bold"><img src="" class="rounded-circle mb-3" style="width: 100px;"/>Welcome ${seslog1 } <a href="#"><img src=""></a></label>
<ul class="nav">
	<li class="nav-item">
...
<table border="1">
		...
		<c:forEach var="rm" items="${list}">
			...
			<td>${rm.city }</td>
			<td>${rm.address }</td>
			<td><a href="edit/${rm.id }">edit</a>
			<td><a href="delete/${rm.id }">delete</a>
		</tr>
		</c:forEach>
</table>
</section>
